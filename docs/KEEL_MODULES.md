...
18 of the 19 modules build and pass their suites standalone. `keel-equipment`'s
suite is the app-test-debt case above; its sources build clean on their own.
