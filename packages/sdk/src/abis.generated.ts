...
export const ABI_CONTRACTS: Readonly<Record<string, readonly string[]>> = {
  ...
  "keel-crucible": ["KeelCollectionAttestationRegistry","KeelCollectionVerificationRegistry","KeelCommunityReplicationRegistry","KeelPixelFingerprintRegistry","KeelPreservationBounty","KeelUriAttestationRegistry"],
  "keel-ip-control": ["KeelIPActionExecutor","KeelIPControl","KeelIPWrapped721"],
  "keel-sleeve": ["KeelSleeve"],
  "keel-web3-url": ["KeelWeb3InlineTokenDemo","KeelWeb3ResourceAdapter","KeelWeb3TokenDemo"],
