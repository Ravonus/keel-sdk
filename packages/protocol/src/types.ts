...
export const KEEL_MANIFEST_SCHEMA = "keel-manifest@2" as const;
export const KEEL_LEGACY_MANIFEST_SCHEMA = "keel-manifest@1" as const;
export const KEEL_CANONICALIZATION = "RFC8785" as const;
export const KEEL_RUNTIME_PROTOCOL = "keel-runtime@1" as const;
export const KEEL_VIEWER_PROTOCOL = "keel-viewer@1" as const;
export const KEEL_CONTENT_GATEWAY_PROTOCOL = "keel-content-gateway@1" as const;
export const KEEL_REGISTRY_ANCHOR_PROTOCOL = "keel-artifact-registry@1" as const;
export const KEEL_THUMBNAIL_PROTOCOL = "keel-thumbnail@1" as const;
...
export const KEEL_OBJECT_INDEX_ENCODING = "keel-object-index@1" as const;
