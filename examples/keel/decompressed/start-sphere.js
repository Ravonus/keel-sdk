function start(libraries) {
  ...
  // Use twgl to create sphere vertices and normals
  const arrays = twgl.primitives.createSphereVertices(1, 48, 24);
  ...
  const floatingSpeed = 0.1 + normalizedSeed * 1.9;
  ...
  function render(time) {
    ...
    twgl.drawBufferInfo(gl, bufferInfo);  // Adjusted this line to work with the buffer info created for the sphere
