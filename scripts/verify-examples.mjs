...
for (const [manifestName, sidecarName] of examples) {
  ...
  if (sidecar.schema !== "keel-manifest-integrity@2") throw new Error(`${sidecarName}: wrong sidecar schema.`);
...
if (metadata.oca_schema !== "keel-manifest@2") throw new Error("metadata.example.json uses the wrong Keel schema.");
